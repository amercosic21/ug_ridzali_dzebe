...
export default function GalleryTeaser() {
  ...
  return (
    <section id="galerija" className="py-12 sm:py-16 lg:py-20 bg-amber">
      <div className="max-w-500 mx-auto px-3 sm:px-6 md:px-10 lg:px-16">
        <ScrollReveal>
          <div className="mb-10 text-center">
            <h2 className="text-[clamp(1.6rem,3.5vw,2.2rem)] font-display font-extrabold text-gray-900 mb-2">
              Iz galerije
            </h2>
          ...
          >
            {picks.map((img, i) => (
              <ZoomImage
                ...
                className="relative rounded-lg lg:rounded-xl cursor-pointer"
              >
      ...
      <Container>
        <ScrollReveal>
          <div className="text-center mt-10">
            <Link
              href="/galerija"
              className="inline-flex items-center gap-2 px-8 py-3.5 rounded-full font-display font-semibold bg-accent text-primary-dark hover:bg-accent-dark hover:-translate-y-0.5 hover:shadow-[0_4px_20px_rgba(255,174,37,0.35)] transition-all duration-300"
            >
              Pogledaj sve slike
