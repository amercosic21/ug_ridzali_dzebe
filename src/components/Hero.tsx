import HeroBgFix from "./hero/HeroBgFix";
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-3xl mx-auto px-4 sm:px-6">
        <h1
          className="text-[clamp(2.2rem,6vw,4rem)] font-display font-extrabold mb-5 leading-tight"
