...
/** Base for 24×24 line icons (fill none, stroke currentColor). */
function StrokeIcon({ width = 24, height = 24, strokeWidth = 1.8, children, ...props }: IconProps) {
  return (
    <svg
      width={width}
      height={height}
...
/** Base for solid icons (fill currentColor). */
function FillIcon({ width = 24, height = 24, viewBox = "0 0 24 24", children, ...props }: IconProps) {
  return (
    <svg width={width} height={height} viewBox={viewBox} fill="currentColor" {...props}>
      {children}
    </svg>
  );
}
...
export function PhoneIcon(props: IconProps) {
  return (
    <StrokeIcon strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export function PineTreeIcon(props: IconProps) {
  return (
    <StrokeIcon strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export function ChevronRightIcon(props: IconProps) {
  return (
    <StrokeIcon strokeWidth={2.5} strokeLinecap="round" strokeLinejoin="round" {...props}>
      <polyline points="9 18 15 12 9 6" />
    </StrokeIcon>
  );
}

export function SearchPlusIcon(props: IconProps) {
  return (
    <StrokeIcon strokeWidth={2} {...props}>
...
export function FootballIcon(props: IconProps) {
  return (
    <FillIcon width={32} height={32} viewBox="0 0 952.1 952.1" {...props}>
